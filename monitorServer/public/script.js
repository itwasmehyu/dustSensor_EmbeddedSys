...
//             // Bắt đầu hoặc cập nhật violation
//             if (!currentViolation) {
//                 currentViolation = {
//                     timestamp: new Date(),
//                     value: latestValue,
...
//                 // Giới hạn lịch sử lưu trữ ở client
...
//         // Cập nhật biểu đồ như bình thường
//         dustChart.data.labels = data.map(entry => {
//             if (!entry.timestamp || !entry.timestamp._seconds) return 'Invalid Date';
//             let date = new Date(entry.timestamp._seconds * 1000);
...
//         // Dù có lỗi API, vẫn cập nhật các trạm đo giả lập
//         updateStationMarkers();
//     }
// }
